...
(function(a) {
    ...
    function w(a, b, c) {
        ...
        for (d = 0; e > d; d++)(c && a[d] !== b[d] ||!c && A(a[d]) !== A(b[d])
            ) && g++;
        return g + f
    }
    function x(a) {
    ...
    }, qc = {}, rc = ["months", "monthsShort", "weekdays", "weekdaysShort", "weekdaysMin"];
    nc.length;
    ...
    pc.DDDD = h(pc.DDD, 3), m(j.prototype, {
        ...
        return tb.isDuration(a) ? h = {
            ...
            y : 0, d : A(i[Cb]) * d, h : A(i[Db]) * d, m : A(i[Eb]) * d, s : A(i[Fb]) * d, ms : A(i[Gb]) * d
